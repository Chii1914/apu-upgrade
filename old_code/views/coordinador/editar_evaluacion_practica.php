...
<head>
  ...
  <title>Practicas - Modificar Evaluación práctica profesional | Administración Pública UV</title>
...
<body>
  ...
  <div class="container">
    <h1>Modificación Evaluación de Práctica Profesional</h1>
    ...
    <div class="row">
      ...
      <?php echo form_open('coordinador/Practica_Controller/actualizar_practica/' . $practicaId, ' onsubmit="return validar(this)"'); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input type="number" name="horas_practica" id="horas_practica" class="form-control" aria-describedby="basic-addon1"  value="<?php echo $datos_practica['horas_practica'] ?>">
            <span class="help-block"></span>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input type="text" name="supervisor_evaluador" id="supervisor_evaluador" class="form-control" aria-describedby="basic-addon1" value="<?= $datos_notas['supervisor_evaluador'] ?>">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input type="email" name="supervisor_evaluador_correo" id="supervisor_evaluador_correo" class="form-control" aria-describedby="basic-addon1" value="<?= $datos_notas['supervisor_evaluador_correo'] ?>">
        ...
        <div class="col-lg-12">
          ...
          <table class="tg">
            <tr>
              ...
              <th class="tg-kiyw"><span style="font-weight:bold">Calificación</span></th>
            </tr>
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  <label class="control-label" for="nota_uno">Nota</label>
                  <input class="form-control" name="nota_uno" id="nota_uno" maxlength="2" type="text" value="<?= $datos_notas['nota_uno'] ?>" oninput="validarNota(this,'nota_uno');" required>
                  <small id="nota_uno_label" class="form-text text-muted">
                  </small>
                </div>
                <!--<input name="nota_uno" id="nota_uno" type="number" min="10" max="70" step="1" value="<?php // $var = ($row_notas['nota_uno']) ? $row_notas['nota_uno'] : '10'; echo $var; 
                                                                                                          ?>" oninput="validarNota(this,'nota_uno');" required>-->
              </td>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  <label class="control-label" for="nota_dos">Nota</label>
                  <input class="form-control" type="text" name="nota_dos" id="nota_dos" maxlength="2" value="<?= $datos_notas['nota_dos'] ?>" oninput="validarNota(this,'nota_dos');" onfocusout="isNotaBlank(this,'nota_dos');" required>
            ...
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_tres" id="nota_tres" maxlength="2" value="<?= $datos_notas['nota_tres'] ?>" oninput="validarNota(this,'nota_tres');" onfocusout="isNotaBlank(this,'nota_tres');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_cuatro" id="nota_cuatro" maxlength="2" value="<?= $datos_notas['nota_cuatro'] ?>" oninput="validarNota(this,'nota_cuatro');" onfocusout="isNotaBlank(this,'nota_cuatro');" required>
            ...
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_cinco" id="nota_cinco" maxlength="2" value="<?= $datos_notas['nota_cinco'] ?>" oninput="validarNota(this,'nota_cinco');" onfocusout="isNotaBlank(this,'nota_cinco');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_seis" id="nota_seis" maxlength="2" value="<?= $datos_notas['nota_seis'] ?>" oninput="validarNota(this,'nota_seis');" onfocusout="isNotaBlank(this,'nota_seis');" required>
            ...
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_siete" id="nota_siete" maxlength="2" value="<?= $datos_notas['nota_siete'] ?>" oninput="validarNota(this,'nota_siete');" onfocusout="isNotaBlank(this,'nota_siete');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_ocho" id="nota_ocho" maxlength="2" value="<?= $datos_notas['nota_ocho'] ?>" oninput="validarNota(this,'nota_ocho');" onfocusout="isNotaBlank(this,'nota_ocho');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_nueve" id="nota_nueve" maxlength="2" value="<?= $datos_notas['nota_nueve'] ?>" oninput="validarNota(this,'nota_nueve');" onfocusout="isNotaBlank(this,'nota_nueve');" required>
            ...
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_diez" id="nota_diez" maxlength="2" value="<?= $datos_notas['nota_diez'] ?>" oninput="validarNota(this,'nota_diez');" onfocusout="isNotaBlank(this,'nota_diez');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_once" id="nota_once" maxlength="2" value="<?= $datos_notas['nota_once'] ?>" oninput="validarNota(this,'nota_once');" onfocusout="isNotaBlank(this,'nota_once');" required>
            ...
            <tr>
              ...
              <td class="tg-fhq0">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_doce" id="nota_doce" maxlength="2" value="<?= $datos_notas['nota_doce'] ?>" oninput="validarNota(this,'nota_doce');" onfocusout="isNotaBlank(this,'nota_doce');" required>
            ...
            <tr>
              ...
              <td class="tg-eh2d">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nota_trece" id="nota_trece" maxlength="2" value="<?= $datos_notas['nota_trece'] ?>" oninput="validarNota(this,'nota_trece');" onfocusout="isNotaBlank(this,'nota_trece');" required>
      ...
      <div class="row">
        <div class="col-lg-5 offset-lg-7">
          <div class="form-group">
            ...
            <input type="number" name="nota_promedio" id="nota_promedio" class="form-control" aria-describedby="basic-addon1" min="1.00" max="7.00" step="0.01" value="" required>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="observaciones" id="observaciones" rows="8" maxlength="900" placeholder="(900 caracteres como máximo)" onkeyup="countChars(this);" required><?= $datos_notas['observaciones'] ?></textarea>


        <div class="form-group">
          <button type="submit" class="btn btn-primary" name="enviar" id="enviar" value="Enviar" required="required"><span class="fa fa-check"></span>Modificar Evaluación practica </button>
    ...
    <script type="text/javascript">
      ...
      this.countChars(document.getElementById("observaciones"));
