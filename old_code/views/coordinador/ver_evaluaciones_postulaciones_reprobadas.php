...
<head>
  ...
  <title>Evaluaciones Reprobadas - Postulaciones a prácticas profesionales | Administración Pública UV</title>
...
<body>
  ...
  <div class="container">
    ...
    <h2>Evaluación Postulaciones Reprobadas</h2>
      ...
      $(document).ready(function() {
        var table = $('#tabla_rechazados').DataTable({
          "ajax": {
            "method": "POST",
            "dataSrc": "",
            "url": "<?php echo base_url('coordinador/Formulario_Controller/ver_postulaciones_aceptadas_evaluacion_rechazadas_ajax') ?>"
          },
          "columns": [{
              "data": "run"
            },
        ...
        $('#tabla_rechazados tbody').on("click", "a.EditarEvaluacionAlumno", function(e) {
          var data = table.row($(this).parents("tr")).data();
          var practica_id = data.practicaId;
          e.preventDefault();
