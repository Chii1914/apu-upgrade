...
<head>
  ...
  <title>[Coordinador(a)] Login Administración de prácticas | Administración Pública UV</title>
...
<img src="<?php echo base_url(); ?>imagenes/logo_apu_blanco.png" alt="" class="img-fluid my-2" style="max-height:120px;">
    <?php echo form_open('coordinador/LoginCoord_Controller/login', ' class="text-center " '); ?>
          ...
          <div class="card-body ">
            <div class="container">
              <div class="md-form">
                ...
                <p class="h1 mb-5">Coordinadores</p>
                <a href="<?php echo base_url('administrador') ?>">Cambiar a Administrador</a>
