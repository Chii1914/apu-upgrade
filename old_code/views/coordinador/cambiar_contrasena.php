...
<body>
  ...
  <div class="container my-5">
    <h1 class="h1">Cambio de contraseña Coordinador(A) </h1>
    <p class="lead"></p>
    <hr class="my-3">
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open('coordinador/Inicio/modificar_contrasena', 'onsubmit="return validar();" class="" '); ?>
        ...
        <input type="hidden" id="coordinador-id" name="coordinador-id" value="<?= $coordinador_id ?>">
