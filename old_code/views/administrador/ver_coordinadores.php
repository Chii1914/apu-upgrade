  ...
  <div class="container">
    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle table-bordered">
        ...
        <tbody>
          <?php foreach ($lista_coordinadores as $coordinador) { ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url("administrador/editar_coordinador") . "/" . $coordinador['id'] ?>" class="btn btn-elegant btn-sm">EditaR</button>
                <a href="#" class="btn btn-danger btn-sm" onclick="confirmarReseteo(<?= $coordinador['id'] ?>)">Resetear Contraseña</button>
              </td>
            </tr>
          <?php } ?>
        </tbody>
